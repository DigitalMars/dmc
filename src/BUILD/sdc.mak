...
HEADERS		= ..\..\include\sys\timeb.h ..\ios\filesys.h ..\..\include\sys\stat.h  \
		...
		..\..\include\ctype.h ..\..\include\stddef.h ..\..\include\limits.h ..\include\scrtl.h  \
		..\..\include\time.h ..\..\include\io.h ..\..\include\errno.h ..\include\mt.h  \
		..\..\include\fltenv.h ..\..\include\fenv.h ..\..\include\eh.h ..\..\include\complex.h  \
		..\..\include\new.h ..\..\include\wchar.h ..\..\include\tchar.h ..\..\include\tabsize.h  \
		..\..\include\mbstring.h ..\..\include\memory.h ..\..\include\search.h ..\..\include\locale.h  \
		..\..\include\malloc.h ..\..\include\signal.h ..\..\include\exitstat.h ..\..\include\direct.h  \
		..\..\include\conio.h ..\..\include\bios.h ..\..\include\assert.h ..\..\include\math.h  \
		..\..\include\fltpnt.h ..\..\include\mbctype.h ..\..\include\disp.h ..\..\include\setjmp.h  \
		..\include\semlock.h ..\..\include\stdarg.h ..\include\scio.h ..\..\include\stream.h  \
...
CFLAGS		=  -Ae -Ar -r -mc -NL -0 -a2 -c -wx -w- -w12 -g -gd 
CFLAGS_1	=  -Ae -Ar -Aa -r -mc -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_1	= -DMSDOS -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -mc -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_2	= -DMSDOS -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -mc -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_3	= -DMSDOS -D_MBCS
CFLAGS_4	=  -r -mc -f -NL -2 -a2 -c -wx -w- -w12 -g -gd
...
CFLAGS		=  -Ae -Ar -r -mc -o+time -NL -0 -a2 -Nc -c -wx -w- -w12 
CFLAGS_1	=  -Ae -Ar -Aa -r -mc -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_1	= -DMSDOS -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -mc -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_2	= -DMSDOS -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -mc -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_3	= -DMSDOS -D_MBCS
CFLAGS_4	=  -Ae -Ar -mc -o+time -f -NL -2 -a2 -Nc -c -wx -w- -w12
DEFINES_4	= -DMSDOS -D_MBCS
LFLAGS		=  /DE /E /PACKF
DEFINES		= -DMSDOS -D_MBCS
!ENDIF
...
POSTLINK	=  C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Bswapc?Pmak 
...
clean:
		...
		-del $(OBJS)
		$(MAKE) -fswapc.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)" $@
...
C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Bswapc?Pmak:
		$(MAKE) -fswapc.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)"
