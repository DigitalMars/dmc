...
HEADERS		= ..\..\include\sys\timeb.h ..\ios\filesys.h ..\..\include\sys\stat.h  \
		..\..\include\share.h ..\..\include\typeinfo.h ..\..\include\fstream.h ..\..\include\fcntl.h  \
		..\..\include\stdio.h ..\..\include\iostream.h ..\..\include\ctype.h ..\..\include\stddef.h  \
		..\..\include\limits.h ..\include\scrtl.h ..\..\include\time.h ..\..\include\io.h  \
		..\..\include\errno.h ..\include\mt.h ..\..\include\fltenv.h ..\..\include\fenv.h  \
		..\..\include\eh.h ..\..\include\complex.h ..\..\include\new.h ..\..\include\wchar.h  \
		..\..\include\tchar.h ..\..\include\tabsize.h ..\..\include\mbstring.h ..\..\include\memory.h  \
		..\..\include\search.h ..\..\include\locale.h ..\..\include\malloc.h ..\..\include\signal.h  \
		..\..\include\exitstat.h ..\..\include\direct.h ..\..\include\conio.h ..\..\include\bios.h  \
		..\..\include\assert.h ..\..\include\math.h ..\..\include\fp.h ..\..\include\fltpnt.h  \
		..\..\include\mbctype.h ..\..\include\disp.h ..\..\include\setjmp.h ..\include\semlock.h  \
		..\..\include\stdarg.h ..\include\scio.h ..\..\include\stream.h ..\..\include\stdiostr.h  \
		..\..\include\generic.h ..\..\include\iomanip.h ..\..\include\strstrea.h ..\..\include\float.h  \
		..\..\include\string.h ..\..\include\stdlib.h ..\..\include\dos.h ..\..\include\process.h  \
		..\..\include\int.h 
...
CFLAGS		=  -Ae -Ar -r -ms -NL -0 -a2 -c -wx -w- -w12 -g -gd 
CFLAGS_1	=  -r -ms -f -NL -2 -a2 -c -wx -w- -w12 -g -gd
DEFINES_1	= -DMSDOS -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -ms -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_2	= -DMSDOS -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -ms -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_3	= -DMSDOS -D_MBCS
CFLAGS_4	=  -Ae -Ar -Aa -r -ms -NL -0 -a2 -c -wx -w- -w12 -g -gd
DEFINES_4	= -DMSDOS -D_MBCS
LFLAGS		=  /CO /DE /PACKF
DEFINES		= -DMSDOS -D_MBCS
!ELSE
OUTPUTDIR	= SDS
!IF EXIST (SDS)
CREATEOUTPUTDIR	=
...
CFLAGS		=  -Ae -Ar -r -ms -o+time -NL -0 -a2 -Nc -c -wx -w- -w12 
CFLAGS_1	=  -Ae -Ar -ms -o+time -f -NL -2 -a2 -Nc -c -wx -w- -w12
DEFINES_1	= -DMSDOS -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -ms -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_2	= -DMSDOS -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -ms -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_3	= -DMSDOS -D_MBCS
CFLAGS_4	=  -Ae -Ar -Aa -r -ms -o+time -NL -0 -a2 -Nc -c -wx -w- -w12
DEFINES_4	= -DMSDOS -D_MBCS
LFLAGS		=  /DE /E /PACKF
DEFINES		= -DMSDOS -D_MBCS
!ENDIF
...
OBJS		=  $(OUTPUTDIR)\dbp.OBJ  $(OUTPUTDIR)\fstream.OBJ  $(OUTPUTDIR)\generr.OBJ  \
		 $(OUTPUTDIR)\ios.OBJ  $(OUTPUTDIR)\iostream.OBJ  $(OUTPUTDIR)\istream.OBJ  $(OUTPUTDIR)\istreamf.OBJ  \
		 $(OUTPUTDIR)\istreami.OBJ  $(OUTPUTDIR)\istreamx.OBJ  $(OUTPUTDIR)\manip.OBJ  $(OUTPUTDIR)\ostream.OBJ  \
		 $(OUTPUTDIR)\ostreamf.OBJ  $(OUTPUTDIR)\ostreami.OBJ  $(OUTPUTDIR)\ostreamx.OBJ  $(OUTPUTDIR)\siosync.OBJ  \
		 $(OUTPUTDIR)\stdiostr.OBJ  $(OUTPUTDIR)\stream.OBJ  $(OUTPUTDIR)\streambf.OBJ  $(OUTPUTDIR)\strstrea.OBJ  \
		 $(OUTPUTDIR)\c.OBJ  $(OUTPUTDIR)\chainint.OBJ  $(OUTPUTDIR)\jmp.OBJ  $(OUTPUTDIR)\msmouse.OBJ  \
		 $(OUTPUTDIR)\sbrk.OBJ  $(OUTPUTDIR)\tsrinit.OBJ  $(OUTPUTDIR)\dosvect.OBJ  $(OUTPUTDIR)\fileinfo.OBJ  \
		 $(OUTPUTDIR)\getcfinf.OBJ  $(OUTPUTDIR)\harderr.OBJ  $(OUTPUTDIR)\setjmp.OBJ  $(OUTPUTDIR)\ztsr.OBJ  \
		 $(OUTPUTDIR)\_afulshr.OBJ  $(OUTPUTDIR)\_anlshl.OBJ  $(OUTPUTDIR)\_anulshr.OBJ  $(OUTPUTDIR)\_fmemicm.OBJ  \
		 $(OUTPUTDIR)\_afftol.OBJ  $(OUTPUTDIR)\_afulrem.OBJ  $(OUTPUTDIR)\_fheap.OBJ  $(OUTPUTDIR)\_fmemset.OBJ  \
		 $(OUTPUTDIR)\fpmath.OBJ  $(OUTPUTDIR)\purecall.OBJ  $(OUTPUTDIR)\_8087.OBJ  $(OUTPUTDIR)\amath.OBJ  \
		 $(OUTPUTDIR)\bios.OBJ  $(OUTPUTDIR)\calloc.OBJ  $(OUTPUTDIR)\cerror.OBJ  $(OUTPUTDIR)\disp.OBJ  \
		 $(OUTPUTDIR)\dos_find.OBJ  $(OUTPUTDIR)\dosalloc.OBJ  $(OUTPUTDIR)\emm.OBJ  $(OUTPUTDIR)\farptr.OBJ  \
		 $(OUTPUTDIR)\fcalloc.OBJ  $(OUTPUTDIR)\float.OBJ  $(OUTPUTDIR)\fmalloc.OBJ  $(OUTPUTDIR)\fmemchr.OBJ  \
		 $(OUTPUTDIR)\fmemcmp.OBJ  $(OUTPUTDIR)\fmemcpy.OBJ  $(OUTPUTDIR)\fmemicmp.OBJ  $(OUTPUTDIR)\fmemset.OBJ  \
		 $(OUTPUTDIR)\fpatan16.OBJ  $(OUTPUTDIR)\fprem16.OBJ  $(OUTPUTDIR)\fptan16.OBJ  $(OUTPUTDIR)\fqq.OBJ  \
		 $(OUTPUTDIR)\frealloc.OBJ  $(OUTPUTDIR)\free.OBJ  $(OUTPUTDIR)\fstrcat.OBJ  $(OUTPUTDIR)\fstrchr.OBJ  \
		 $(OUTPUTDIR)\fstrcmp.OBJ  $(OUTPUTDIR)\fstrcpy.OBJ  $(OUTPUTDIR)\fstricmp.OBJ  $(OUTPUTDIR)\fstrlen.OBJ  \
		 $(OUTPUTDIR)\fstrncat.OBJ  $(OUTPUTDIR)\fstrncmp.OBJ  $(OUTPUTDIR)\fstrncpy.OBJ  $(OUTPUTDIR)\handle.OBJ  \
		 $(OUTPUTDIR)\hdiff.OBJ  $(OUTPUTDIR)\hugeptr.OBJ  $(OUTPUTDIR)\inter.OBJ  $(OUTPUTDIR)\kbhit.OBJ  \
		 $(OUTPUTDIR)\lmath.OBJ  $(OUTPUTDIR)\lseek.OBJ  $(OUTPUTDIR)\malloc.OBJ  $(OUTPUTDIR)\msize.OBJ  \
		 $(OUTPUTDIR)\parall.OBJ  $(OUTPUTDIR)\patch16.OBJ  $(OUTPUTDIR)\peek.OBJ  $(OUTPUTDIR)\realloc.OBJ  \
		 $(OUTPUTDIR)\stkovfl.OBJ  $(OUTPUTDIR)\strchr.OBJ  $(OUTPUTDIR)\strcmp.OBJ  $(OUTPUTDIR)\strcpy.OBJ  \
		 $(OUTPUTDIR)\strlen.OBJ  $(OUTPUTDIR)\strncmp.OBJ  $(OUTPUTDIR)\sysint.OBJ  $(OUTPUTDIR)\_fmemmve.OBJ  \
		 $(OUTPUTDIR)\_fstrchr.OBJ  $(OUTPUTDIR)\_fstrtok.OBJ  $(OUTPUTDIR)\_nstrdup.OBJ  $(OUTPUTDIR)\allocmem.OBJ  \
		 $(OUTPUTDIR)\ctrlbrk.OBJ  $(OUTPUTDIR)\far.OBJ  $(OUTPUTDIR)\fstrcspn.OBJ  $(OUTPUTDIR)\fstrdup.OBJ  \
		 ...
		 $(OUTPUTDIR)\fstrstr.OBJ  $(OUTPUTDIR)\fstrtok.OBJ  $(OUTPUTDIR)\fstrupr.OBJ  $(OUTPUTDIR)\getdate.OBJ  \
		 $(OUTPUTDIR)\mallocf.OBJ  $(OUTPUTDIR)\ptrchk.OBJ  $(OUTPUTDIR)\_ptrchk.OBJ  $(OUTPUTDIR)\atoi.OBJ  \
		 $(OUTPUTDIR)\atol.OBJ  $(OUTPUTDIR)\baslnk.OBJ  $(OUTPUTDIR)\chkstk.OBJ  $(OUTPUTDIR)\cinit.OBJ  \
		 $(OUTPUTDIR)\clock.OBJ  $(OUTPUTDIR)\controlc.OBJ  $(OUTPUTDIR)\country.OBJ  $(OUTPUTDIR)\cputype.OBJ  \
		 $(OUTPUTDIR)\dclass.OBJ  $(OUTPUTDIR)\dosdate.OBJ  $(OUTPUTDIR)\doserr.OBJ  $(OUTPUTDIR)\dosfil.OBJ  \
		 $(OUTPUTDIR)\double.OBJ  $(OUTPUTDIR)\dup.OBJ  $(OUTPUTDIR)\ehasm.OBJ  $(OUTPUTDIR)\exec2.OBJ  \
		 $(OUTPUTDIR)\filelen.OBJ  $(OUTPUTDIR)\find.OBJ  $(OUTPUTDIR)\floattyp.OBJ  $(OUTPUTDIR)\flt87.OBJ  \
		 $(OUTPUTDIR)\fputc.OBJ  $(OUTPUTDIR)\getcwd.OBJ  $(OUTPUTDIR)\getdos.OBJ  $(OUTPUTDIR)\getenv.OBJ  \
		 $(OUTPUTDIR)\getthd.OBJ  $(OUTPUTDIR)\io.OBJ  $(OUTPUTDIR)\itoa.OBJ  $(OUTPUTDIR)\ldexp.OBJ  \
		 $(OUTPUTDIR)\locking.OBJ  $(OUTPUTDIR)\math87.OBJ  $(OUTPUTDIR)\mathtrn.OBJ  $(OUTPUTDIR)\mathtrnf.OBJ  \
		 ...
		 $(OUTPUTDIR)\ncalloc.OBJ  $(OUTPUTDIR)\nmalloc.OBJ  $(OUTPUTDIR)\nrealloc.OBJ  $(OUTPUTDIR)\page.OBJ  \
		 $(OUTPUTDIR)\port.OBJ  $(OUTPUTDIR)\read.OBJ  $(OUTPUTDIR)\rot.OBJ  $(OUTPUTDIR)\seg.OBJ  \
		 $(OUTPUTDIR)\sound.OBJ  $(OUTPUTDIR)\stpcpy.OBJ  $(OUTPUTDIR)\strcat.OBJ  $(OUTPUTDIR)\strcmpl.OBJ  \
		 $(OUTPUTDIR)\strncat.OBJ  $(OUTPUTDIR)\strncpy.OBJ  $(OUTPUTDIR)\strtoul.OBJ  $(OUTPUTDIR)\utime.OBJ  \
		 $(OUTPUTDIR)\write.OBJ  $(OUTPUTDIR)\_dup.OBJ  $(OUTPUTDIR)\_fcvt.OBJ  $(OUTPUTDIR)\_fgtchar.OBJ  \
		 $(OUTPUTDIR)\_fopen.OBJ  $(OUTPUTDIR)\_fptchar.OBJ  $(OUTPUTDIR)\_ismbbld.OBJ  $(OUTPUTDIR)\_ismbbtl.OBJ  \
		 $(OUTPUTDIR)\_itoa.OBJ  $(OUTPUTDIR)\_ltoa.OBJ  $(OUTPUTDIR)\_main.OBJ  $(OUTPUTDIR)\_memicmp.OBJ  \
		 $(OUTPUTDIR)\_printf.OBJ  $(OUTPUTDIR)\_strdup.OBJ  $(OUTPUTDIR)\_strerro.OBJ  $(OUTPUTDIR)\_strrev.OBJ  \
		 $(OUTPUTDIR)\_tzset.OBJ  $(OUTPUTDIR)\arcerr.OBJ  $(OUTPUTDIR)\asctime.OBJ  $(OUTPUTDIR)\asin.OBJ  \
		 ...
		 $(OUTPUTDIR)\chsize.OBJ  $(OUTPUTDIR)\commit.OBJ  $(OUTPUTDIR)\cprintf.OBJ  $(OUTPUTDIR)\cputs.OBJ  \
		 $(OUTPUTDIR)\creat.OBJ  $(OUTPUTDIR)\cscanf.OBJ  $(OUTPUTDIR)\ctime.OBJ  $(OUTPUTDIR)\ctype.OBJ  \
		 ...
		 $(OUTPUTDIR)\ecvt.OBJ  $(OUTPUTDIR)\eof.OBJ  $(OUTPUTDIR)\execl.OBJ  $(OUTPUTDIR)\execle.OBJ  \
		 $(OUTPUTDIR)\execlp.OBJ  $(OUTPUTDIR)\execlpe.OBJ  $(OUTPUTDIR)\execv.OBJ  $(OUTPUTDIR)\execve.OBJ  \
		 $(OUTPUTDIR)\execvp.OBJ  $(OUTPUTDIR)\execvpe.OBJ  $(OUTPUTDIR)\exit.OBJ  $(OUTPUTDIR)\exitstat.OBJ  \
		 $(OUTPUTDIR)\exp.OBJ  $(OUTPUTDIR)\fatexit.OBJ  $(OUTPUTDIR)\fclose.OBJ  $(OUTPUTDIR)\fcloseal.OBJ  \
		 ...
		 $(OUTPUTDIR)\fonexit.OBJ  $(OUTPUTDIR)\fopen.OBJ  $(OUTPUTDIR)\fpsig.OBJ  $(OUTPUTDIR)\fputchar.OBJ  \
		 $(OUTPUTDIR)\fputs.OBJ  $(OUTPUTDIR)\fread.OBJ  $(OUTPUTDIR)\freect.OBJ  $(OUTPUTDIR)\freopen.OBJ  \
		 $(OUTPUTDIR)\fsopen.OBJ  $(OUTPUTDIR)\ftime.OBJ  $(OUTPUTDIR)\fwrite.OBJ  $(OUTPUTDIR)\gcvt.OBJ  \
		 $(OUTPUTDIR)\getchar.OBJ  $(OUTPUTDIR)\getpid.OBJ  $(OUTPUTDIR)\gets.OBJ  $(OUTPUTDIR)\heap.OBJ  \
		 $(OUTPUTDIR)\hyper.OBJ  $(OUTPUTDIR)\ieee.OBJ  $(OUTPUTDIR)\iob.OBJ  $(OUTPUTDIR)\isalnum.OBJ  \
		 $(OUTPUTDIR)\isalpha.OBJ  $(OUTPUTDIR)\isascii.OBJ  $(OUTPUTDIR)\iscntrl.OBJ  $(OUTPUTDIR)\iscsym.OBJ  \
		 $(OUTPUTDIR)\iscsymf.OBJ  $(OUTPUTDIR)\isdigit.OBJ  $(OUTPUTDIR)\isgraph.OBJ  $(OUTPUTDIR)\islower.OBJ  \
		 $(OUTPUTDIR)\isprint.OBJ  $(OUTPUTDIR)\ispunct.OBJ  $(OUTPUTDIR)\isspace.OBJ  $(OUTPUTDIR)\isupper.OBJ  \
		 $(OUTPUTDIR)\isxdigit.OBJ  $(OUTPUTDIR)\lconv.OBJ  $(OUTPUTDIR)\lfind.OBJ  $(OUTPUTDIR)\loctime.OBJ  \
		 $(OUTPUTDIR)\log.OBJ  $(OUTPUTDIR)\lsearch.OBJ  $(OUTPUTDIR)\ltoa.OBJ  $(OUTPUTDIR)\matherr.OBJ  \
		 $(OUTPUTDIR)\mbctype.OBJ  $(OUTPUTDIR)\mbstowcs.OBJ  $(OUTPUTDIR)\mbstring.OBJ  $(OUTPUTDIR)\mbyte.OBJ  \
		 $(OUTPUTDIR)\memccpy.OBJ  $(OUTPUTDIR)\mktemp.OBJ  $(OUTPUTDIR)\nmsize.OBJ  $(OUTPUTDIR)\okbigbuf.OBJ  \
		 $(OUTPUTDIR)\onexit.OBJ  $(OUTPUTDIR)\perror.OBJ  $(OUTPUTDIR)\poly.OBJ  $(OUTPUTDIR)\pow.OBJ  \
		 $(OUTPUTDIR)\printf.OBJ  $(OUTPUTDIR)\putch.OBJ  $(OUTPUTDIR)\putchar.OBJ  $(OUTPUTDIR)\putenv.OBJ  \
		 $(OUTPUTDIR)\puts.OBJ  $(OUTPUTDIR)\qsort.OBJ  $(OUTPUTDIR)\rand.OBJ  $(OUTPUTDIR)\response.OBJ  \
		 $(OUTPUTDIR)\rmtmp.OBJ  $(OUTPUTDIR)\round.OBJ  $(OUTPUTDIR)\scanf.OBJ  $(OUTPUTDIR)\setdoser.OBJ  \
		 ...
		 $(OUTPUTDIR)\cstrm.OBJ  $(OUTPUTDIR)\ctrig.OBJ  $(OUTPUTDIR)\except.OBJ  $(OUTPUTDIR)\rtti.OBJ  \
		 $(OUTPUTDIR)\typeinfo.OBJ  $(OUTPUTDIR)\vecnew.OBJ  $(OUTPUTDIR)\vector.OBJ  $(OUTPUTDIR)\scver.OBJ  \
...
POSTLINK	=  c?C?Bsource?B75?BRTL?BSRC?BBUILD?Bct?Pmak 
...
all:	createdir $(PRECOMPILE) $(SYMS) $(OBJS) $(INCLUDEDOBJS) $(POSTCOMPILE) $(TARGETDIR)\$(PROJ).lib $(POSTLINK) _done

createdir:
	$(CREATEOUTPUTDIR)
	$(CREATETARGETDIR)

$(TARGETDIR)\$(PROJ).lib: $(OBJS) $(INCLUDEDOBJS)
...
clean:
		...
		-del sds.dpd
		-del $(OBJS)
		$(MAKE) -fct.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)" $@
...
c?C?Bsource?B75?BRTL?BSRC?BBUILD?Bct?Pmak:
		$(MAKE) -fct.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)"
...
$(OUTPUTDIR)\c.OBJ:	..\dos16\c.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\c.obj ..\dos16\c.asm



$(OUTPUTDIR)\chainint.OBJ:	..\dos16\chainint.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\chainint.obj ..\dos16\chainint.asm



$(OUTPUTDIR)\jmp.OBJ:	..\dos16\jmp.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\jmp.obj ..\dos16\jmp.asm



$(OUTPUTDIR)\msmouse.OBJ:	..\dos16\msmouse.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\msmouse.obj ..\dos16\msmouse.asm



$(OUTPUTDIR)\sbrk.OBJ:	..\dos16\sbrk.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\sbrk.obj ..\dos16\sbrk.asm



$(OUTPUTDIR)\tsrinit.OBJ:	..\dos16\tsrinit.asm
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\tsrinit.obj ..\dos16\tsrinit.asm



$(OUTPUTDIR)\dosvect.OBJ:	..\dos16\dosvect.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\dosvect.obj ..\dos16\dosvect.c



$(OUTPUTDIR)\fileinfo.OBJ:	..\core\fileinfo.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\fileinfo.obj ..\core\fileinfo.c



$(OUTPUTDIR)\getcfinf.OBJ:	..\dos16\getcfinf.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\getcfinf.obj ..\dos16\getcfinf.c



$(OUTPUTDIR)\harderr.OBJ:	..\dos16\harderr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\harderr.obj ..\dos16\harderr.c
...
$(OUTPUTDIR)\ztsr.OBJ:	..\dos16\ztsr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ztsr.obj ..\dos16\ztsr.c
