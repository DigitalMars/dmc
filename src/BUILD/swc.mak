...
DEFINES_3	= -D_MBCS
CFLAGS_4	=  -Ae -Ar -r -mc -Waewmtx -D_WINDOWS -f -NL -4 -a2 -Nc -c -wx -w- -w12 -g -gd
DEFINES_4	= -D_MBCS
...
DEFINES_3	= -D_MBCS
CFLAGS_4	=  -Ae -Ar -r -mc -o+time -Waewmtx -D_WINDOWS -f -NL -4 -a2 -Nc -c -wx -w- -w12
DEFINES_4	= -D_MBCS
...
PRECOMPILE	=  C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Bcwindos?Pprj 
...
clean:
		...
		-del $(OBJS)
		$(MAKE) -fcwindos.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)" $@
...
C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Bcwindos?Pprj:
		$(MAKE) -fcwindos.mak "SUB_DEBUG=$(DEBUG)"
