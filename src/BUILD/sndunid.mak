...
HEADERS		= ..\include\semlock.h ..\include\ehsup.h ..\include\mt.h  \
		..\..\include\assert.h ..\..\include\share.h ..\..\include\fp.h ..\..\include\fltpnt.h  \
		..\..\include\fcntl.h ..\..\include\stddef.h ..\..\include\math.h ..\include\crtdbg.h  \
		..\include\dbgint.h ..\..\include\heapstat.h ..\..\include\malloc.h ..\..\include\limits.h  \
		..\include\setlocal.h ..\..\include\locale.h ..\include\lcapi32.h ..\include\scio.h  \
		..\include\scrtl.h ..\..\include\dos.h ..\..\include\fenv.h ..\..\include\fltenv.h  \
		..\..\include\float.h ..\..\include\errno.h ..\include\sctchar.h ..\..\include\time.h  \
		..\..\include\stdio.h ..\..\include\sys\stat.h ..\..\include\process.h ..\..\include\io.h  \
		..\..\include\direct.h ..\..\include\wchar.h ..\..\include\tchar.h 
...
SYMROOT		=  sndunid\precomp 
SYMS		= $(SYMROOT).SYM 
LIBS		= 

CFLAGS		=  -HIprecomp.h -Ae -Ar -r -mn -S -NL -ND -5 -a8 -c -H -HDsndunid -HO- -wx -g 
CFLAGS_1	=  -HIprecomp.h -Ae -Ar -r -mn -S -NL -ND -5 -a8 -c -H -HDsndunid -HO- -wx
DEFINES_1	= -D_MT -DUNICODE -D_DEBUG -D_DLL -D_CRTBLD -D_UNICODE=1
LFLAGS		=  /CO /NOI /DE /XN /A:512
DEFINES		= -D_MT -DUNICODE -D_DEBUG -D_DLL -D_CRTBLD -D_UNICODE=1
!ELSE
OUTPUTDIR	= snduni
!IF EXIST (snduni)
CREATEOUTPUTDIR	=
...
CFLAGS_1	=  -HIprecomp.h -Ae -Ar -r -mn -o+time -NL -ND -5 -a8 -Nc -c -H -HDsnduni -HO- -wx
...
OBJS		=  $(OUTPUTDIR)\wasctime.OBJ  $(OUTPUTDIR)\wchdir.OBJ  \
...
.H.SYM:
	$(CC) $(HFLAGS) $(DEFINES) $(INCLUDES) -HF -osndunid\$(*B).sym $*.h

.HPP.SYM:
	$(CC) $(HFLAGS) $(DEFINES) $(INCLUDES) -HF -osndunid\$(*B).sym $*.hpp

.HXX.SYM:
	$(CC) $(HFLAGS) $(DEFINES) $(INCLUDES) -HF -osndunid\$(*B).sym $*.hxx
...
.OBJ.EXE:
		$(LNK) $(LFLAGS) @<<$(PROJ).LNK
sndunid\precomp.PCO+
sndunid\wasctime.OBJ+
sndunid\wchdir.OBJ+
sndunid\wchmod.OBJ+
sndunid\wconstar.OBJ+
sndunid\wcscat.OBJ+
sndunid\wcscmp.OBJ+
sndunid\wcscoll.OBJ+
sndunid\wcscspn.OBJ+
sndunid\wcsftime.OBJ+
sndunid\wcsicmp.OBJ+
sndunid\wcsicoll.OBJ+
sndunid\wcslen.OBJ+
sndunid\wcslwr.OBJ+
sndunid\wcsncat.OBJ+
sndunid\wcsncmp.OBJ+
sndunid\wcsncoll.OBJ+
sndunid\wcsncpy.OBJ+
sndunid\wcsnicol.OBJ+
sndunid\wcsnset.OBJ+
sndunid\wcspbrk.OBJ+
sndunid\wcsrchr.OBJ+
sndunid\wcsrev.OBJ+
...
sndunid\wexecle.OBJ+
sndunid\wexeclp.OBJ+
sndunid\wexeclpe.OBJ+
sndunid\wexecv.OBJ+
sndunid\wexecve.OBJ+
sndunid\wexecvp.OBJ+
sndunid\wexecvpe.OBJ+
sndunid\wfdopen.OBJ+
sndunid\wfind.OBJ+
sndunid\wfloatcv.OBJ+
sndunid\wfmt.OBJ+
sndunid\wfopen.OBJ+
sndunid\wfreopen.OBJ+
sndunid\wfsopen.OBJ+
sndunid\wfullpat.OBJ+
sndunid\wgetcwd.OBJ+
sndunid\wgetdcwd.OBJ+
sndunid\wio.OBJ+
sndunid\wmakepat.OBJ+
sndunid\wmkdir.OBJ+
sndunid\wmktemp.OBJ+
sndunid\wperror.OBJ+
sndunid\wprintf.OBJ+
sndunid\wrddir.OBJ+
sndunid\wscanf.OBJ+
sndunid\wsearche.OBJ+
sndunid\wsetargv.OBJ+
sndunid\wsetloca.OBJ+
sndunid\wsopenf.OBJ+
sndunid\wspawlpe.OBJ+
sndunid\wspawn.OBJ+
sndunid\wspawnl.OBJ+
sndunid\wspawnle.OBJ+
sndunid\wspawnlp.OBJ+
sndunid\wspawnv.OBJ+
sndunid\wspawnve.OBJ+
sndunid\wspawnvp.OBJ+
sndunid\wspawvpe.OBJ+
sndunid\wsplitpa.OBJ+
sndunid\wstat.OBJ+
sndunid\wstrdate.OBJ+
sndunid\wstrtime.OBJ+
sndunid\wsystem.OBJ+
sndunid\wtmpnam.OBJ+
sndunid\wunlink.OBJ+
sndunid\wutime.OBJ+
sndunid\wwinstar.OBJ+
sndunid\wtoi.OBJ+
sndunid\wtol.OBJ+
sndunid\_wprintf.OBJ+
sndunid\_wfopen.OBJ
.\$$SCW$$.LIB
NUL
...
$(TARGETDIR)\$(PROJ).$(PROJTYPE): $(SYMS) $(OBJS) $(INCLUDEDOBJS) $(RCFILES) $(RESFILES) $(HELPFILES) 
		...
		LIB $(TARGETDIR)\$$SCW$$.$(PROJTYPE) $(LIBFLAGS)\
				@<<
 + $(OUTPUTDIR)\wasctime.OBJ + $(OUTPUTDIR)\wchdir.OBJ &
		 + $(OUTPUTDIR)\wchmod.OBJ + $(OUTPUTDIR)\wconstar.OBJ + $(OUTPUTDIR)\wcscat.OBJ + $(OUTPUTDIR)\wcscmp.OBJ &
		 + $(OUTPUTDIR)\wcscoll.OBJ + $(OUTPUTDIR)\wcscspn.OBJ + $(OUTPUTDIR)\wcsftime.OBJ + $(OUTPUTDIR)\wcsicmp.OBJ &
		 + $(OUTPUTDIR)\wcsicoll.OBJ + $(OUTPUTDIR)\wcslen.OBJ + $(OUTPUTDIR)\wcslwr.OBJ + $(OUTPUTDIR)\wcsncat.OBJ &
		 + $(OUTPUTDIR)\wcsncmp.OBJ + $(OUTPUTDIR)\wcsncoll.OBJ + $(OUTPUTDIR)\wcsncpy.OBJ + $(OUTPUTDIR)\wcsnicol.OBJ &
