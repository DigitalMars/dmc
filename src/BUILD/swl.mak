...
HEADERS		= ..\..\include\process.h ..\..\include\int.h ..\..\include\locale.h  \
		...
		..\..\include\float.h ..\..\include\string.h ..\..\include\stdlib.h ..\..\include\dos.h  \
		..\..\include\sys\timeb.h 
...
CFLAGS		=  -Ae -Ar -r -ml -Waewmtx -D_WINDOWS -NL -4 -a2 -c -wx -w- -w12 -g -gd 
CFLAGS_1	=  -Ae -Ar -Aa -r -ml -Waewmtx -D_WINDOWS -NL -4 -a2 -c -wx -w- -w12 -g -gd
DEFINES_1	= -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -ml -Waewmtx -D_WINDOWS -NL -4 -a2 -c -wx -w- -w12 -g -gd
DEFINES_2	= -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -ml -Waewmtx -D_WINDOWS -NL -4 -a2 -c -wx -w- -w12 -g -gd
DEFINES_3	= -D_MBCS
CFLAGS_4	=  -Ae -Ar -r -ml -Waewmtx -D_WINDOWS -f -NL -4 -a2 -Nc -c -wx -w- -w12 -g -gd
DEFINES_4	= -D_MBCS
...
CFLAGS		=  -Ae -Ar -r -ml -o+time -Waewmtx -D_WINDOWS -NL -4 -a2 -Nc -c -wx -w- -w12 
CFLAGS_1	=  -Ae -Ar -Aa -r -ml -o+time -Waewmtx -D_WINDOWS -NL -4 -a2 -Nc -c -wx -w- -w12
DEFINES_1	= -D_MBCS
CFLAGS_2	=  -Ae -Ar -Aa -r -ml -o+time -Waewmtx -D_WINDOWS -NL -4 -a2 -Nc -c -wx -w- -w12
DEFINES_2	= -D_MBCS
CFLAGS_3	=  -Ae -Ar -Aa -r -ml -o+time -Waewmtx -D_WINDOWS -NL -4 -a2 -Nc -c -wx -w- -w12
DEFINES_3	= -D_MBCS
CFLAGS_4	=  -Ae -Ar -r -ml -o+time -Waewmtx -D_WINDOWS -f -NL -4 -a2 -Nc -c -wx -w- -w12
DEFINES_4	= -D_MBCS
...
OBJS		=  $(OUTPUTDIR)\_8087.OBJ  $(OUTPUTDIR)\_afulshr.OBJ  $(OUTPUTDIR)\_anlshl.OBJ  \
		 ...
		 $(OUTPUTDIR)\adelete.OBJ  $(OUTPUTDIR)\anew2.OBJ  $(OUTPUTDIR)\corenew.OBJ  $(OUTPUTDIR)\purevirt.OBJ  \
...
PRECOMPILE	=  C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Blwindos?Pprj 
...
clean:
		...
		-del $(OBJS)
		$(MAKE) -flwindos.mak $(MFLAGS) "SUB_DEBUG=$(DEBUG)" $@
...
C?C?Bsource?B75?BRTL?Bsrc?Bbuild?Blwindos?Pprj:
		$(MAKE) -flwindos.mak "SUB_DEBUG=$(DEBUG)"
