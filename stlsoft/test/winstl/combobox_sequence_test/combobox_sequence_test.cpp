/* /////////////////////////////////////////////////////////////////////////////
 * File:		combobox_sequence_test.cpp
 *
 * Purpose:
 *
...
#include <winstl_combobox_sequence.h>
...
{
	typedef winstl_ns_qual(combobox_sequence)<string>	combobox_sequence;

	HWND	hwndListBox	=	::CreateWindowExA(0, "COMBOBOX", "", CBS_SORT, 0, 0, 0, 0, 0, 0, 0, 0);

	SendMessage(hwndListBox, CB_ADDSTRING, 0, StrT2LPARAM("String 3"));
	SendMessage(hwndListBox, CB_ADDSTRING, 0, StrT2LPARAM("String 2"));
	SendMessage(hwndListBox, CB_ADDSTRING, 0, StrT2LPARAM("String 45"));
	SendMessage(hwndListBox, CB_ADDSTRING, 0, StrT2LPARAM("String 1"));

	combobox_sequence					lbs(hwndListBox);
