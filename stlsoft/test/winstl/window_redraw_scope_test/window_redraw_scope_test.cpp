/* /////////////////////////////////////////////////////////////////////////////
 * File:        window_redraw_scope_test.cpp
 *
 * Purpose:     Implementation file for the window_redraw_scope_test project.
 *
...
static BOOL CALLBACK Window_redraw_scopeDialogProc(	HWND    hwnd,
													UINT    uMsg,
													WPARAM  wParam,
													LPARAM  lParam);
...
int WINAPI WinMain( HINSTANCE   hinst,
                    ...
                    int         /* nCmdShow */)
{
    ::DialogBoxParam(hinst, Id2StrT(IDD_WINDOW_REDRAW_SCOPE), NULL, Window_redraw_scopeDialogProc, 0);

    return 0;
}


static BOOL Window_redraw_scope_OnInitDialog(HWND /* hwnd */, HWND /* hwndFocus */, LPARAM /* lParam */)
{
    return false;
}

static BOOL Window_redraw_scope_OnCommand(HWND hwnd, int /* code */, int idCtrl, HWND /* hwndCtrl */)
{
    BOOL    bRet    =   false;
...
BOOL CALLBACK Window_redraw_scopeDialogProc(HWND    hwnd,
                                            UINT    uMsg,
                                            WPARAM  wParam,
                                            LPARAM  lParam)
{
    ...
    {
        case    WM_INITDIALOG:
            bRet = Window_redraw_scope_OnInitDialog(hwnd, WPARAM2HWND(wParam), lParam);
            break;
        case    WM_COMMAND:
            bRet = Window_redraw_scope_OnCommand(hwnd, (int)HIWORD(wParam), (int) LOWORD(wParam), LPARAM2HWND(lParam));
            break;
    }
