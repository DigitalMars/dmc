/* /////////////////////////////////////////////////////////////////////////////
 * File:        fixed_array_test.cpp
 *
 * Purpose:     Test for fixed array classes
 *
 * Created:
...
stlsoft_ns_using(fixed_array_1d)
stlsoft_ns_using(fixed_array_2d)
stlsoft_ns_using(fixed_array_3d)
stlsoft_ns_using(fixed_array_4d)
...
{
#ifdef _STLSOFT_INCL_H_STLSOFT_FIXED_ARRAY
	typedef fixed_array_4d	<	ss_uint32_t
							,	new_allocator<ss_uint32_t>
							,	do_construction<ss_uint32_t>
							>		array_t;

	ss_uint32_t		i;
	array_t			array1(2, 4, 6, 8);
