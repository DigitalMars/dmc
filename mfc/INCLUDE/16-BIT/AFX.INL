...
_AFX_INLINE CArchive& CArchive::operator>>(double& d)
	{ if (sizeof(double) > m_lpBufMax - m_lpBufCur)
...
_AFX_INLINE CArchive& CArchive::operator>>(LONG& l)
	{ if (sizeof(LONG) > m_lpBufMax - m_lpBufCur)
