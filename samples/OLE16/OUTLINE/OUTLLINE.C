...
BOOL Line_SaveToStg(LPLINE lpLine, UINT uFormat, LPSTORAGE lpSrcStg, LPSTORAGE lpDestStg, LPSTREAM lpLLStm, BOOL fRemember)
{
	...
	lineRecord.m_lineType = lpLine->m_lineType;
	lineRecord.m_nTabLevel = lpLine->m_nTabLevel;
	lineRecord.m_nTabWidthInHimetric = lpLine->m_nTabWidthInHimetric;
	lineRecord.m_nWidthInHimetric = lpLine->m_nWidthInHimetric;
	lineRecord.m_nHeightInHimetric = lpLine->m_nHeightInHimetric;
...
LPLINE Line_LoadFromStg(LPSTORAGE lpSrcStg, LPSTREAM lpLLStm, LPOUTLINEDOC lpDestDoc)
{
	...
	lpLine->m_lineType = lineRecord.m_lineType;
	lpLine->m_nTabLevel = lineRecord.m_nTabLevel;
	lpLine->m_nTabWidthInHimetric = lineRecord.m_nTabWidthInHimetric;
	lpLine->m_nWidthInHimetric = lineRecord.m_nWidthInHimetric;
	lpLine->m_nHeightInHimetric = lineRecord.m_nHeightInHimetric;
